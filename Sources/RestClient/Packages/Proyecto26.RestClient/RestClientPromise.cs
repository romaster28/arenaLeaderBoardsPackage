...
using LeaderBoard.Sources.RestClient.Packages.RSG.Promise;
using RequestHelper = LeaderBoard.Sources.RestClient.Packages.Proyecto26.RestClient.Helpers.RequestHelper;

namespace LeaderBoard.Sources.RestClient.Packages.Proyecto26.RestClient
{
    public static partial class RClient
    {
