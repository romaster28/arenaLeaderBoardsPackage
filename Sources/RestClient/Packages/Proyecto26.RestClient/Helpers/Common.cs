...
namespace LeaderBoard.Sources.RestClient.Packages.Proyecto26.RestClient.Helpers
{
    public static class Common
    {
        ...
        private static void ConfigureWebRequestWithOptions(UnityWebRequest request, byte[] bodyRaw, string contentType, RequestHelper options)
        {
            ...
            foreach (var header in global::LeaderBoard.Sources.RestClient.Packages.Proyecto26.RestClient.RClient.DefaultRequestHeaders)
            {
