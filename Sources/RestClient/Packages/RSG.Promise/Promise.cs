...
using System.Linq;
using LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Exceptions;

namespace LeaderBoard.Sources.RestClient.Packages.RSG.Promise
{
    /// <summary>
    ...
    public class Promise<PromisedT> : IPromise<PromisedT>, IPendingPromise<PromisedT>, IPromiseInfo
    {
        ...
        public Promise()
        {
            ...
            this.id = global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.NextId();

            if (global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.EnablePromiseTracking)
            {
                global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.PendingPromises.Add(this);
            }
        }
...
//            Argument.NotNull(() => ex);
            ...
            if (global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.EnablePromiseTracking)
            {
                global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.PendingPromises.Remove(this);
            }
        ...
        public void Done(Action<PromisedT> onResolved, Action<Exception> onRejected)
        {
            Then(onResolved, onRejected)
                .Catch(ex =>
                    global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.PropagateUnhandledException(this, ex)
                );
        }
        ...
        {
            var resultPromise = new global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise();
...
//            Argument.NotNull(() => transform);
        ...
        {
            return Then(value => global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.All(chain(value)));
        }
        ...
        {
            return Then(value => global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise.Race(chain(value)));
        }
...
//            Argument.NotNull(() => ex);
        ...
        {
            var promise = new global::LeaderBoard.Sources.RestClient.Packages.RSG.Promise.Promise();
            promise.WithName(Name);
